...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TodoForm = __webpack_require__(161);
	var TodoTable = __webpack_require__(162);
	...
	var TodoForm = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement('input', { ref: 'content', className: 'form-control', type: 'text' }),
	            React.createElement(
	                'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TodoItem = __webpack_require__(163);

	var TodoTable = React.createClass({
	    displayName: 'TodoTable',

	    render: function () {
	        var todos = this.props.todos.map((function (item) {
	            return React.createElement(TodoItem, { key: item.id, todo: item,
	    ...
	    render: function () {
	        ...
	        if (item.status == 0) {
	            updateButton = React.createElement(
	                "button",
	                { onClick: this.handleUpdate.bind(this, item.id, 1), className: "btn btn-success operator" },
	                "Done"
	            );
	        } else {
	            updateButton = React.createElement(
	                "button",
	                { onClick: this.handleUpdate.bind(this, item.id, 0), className: "btn btn-primary operator" },
	                "Undone"
	            );
	        }
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "button",
	                    { onClick: this.handleDelete.bind(this, item.id), className: "btn btn-danger operator" },
	                    "Delete"
	                )
	            )
	        );
